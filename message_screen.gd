...
var tutorial: Array = [
	...
	["ONE LAST THING...","Some days will not be like the others, and will apply modifiers to the card you pick. Use them to offset some of the tougher choices...\n\nBut that was it. Now GO!"]
]
...
func play_tutorial() -> void:
	if (tutorial_slide < tutorial.size()):
